...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    navigation.items do |primary|
      ...
      primary.dom_attributes = {id: 'main-menu-navigation', class: 'navigation navigation-main'}

      # primary.dom_class = 'navigation-menu'
      primary.item :dashboard, 'Dashboard', root_path
      primary.item :applications, Application.model_name.human(count: 2), applications_path
    end
  end
end
